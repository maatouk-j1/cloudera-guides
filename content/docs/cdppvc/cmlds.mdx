...
topicSlug: "cdppvc"
---
This article explains the steps to deploy the CML service on the Kubernetes platform after successful configuration of the [CDP PvC Data Services Management Console](dsconsole.md).
