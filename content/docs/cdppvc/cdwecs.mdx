...
topicSlug: "cdppvc"
---
This article explains the steps to deploy the CDW service on ECS platform after successful configuration of the [CDP PvC Data Services Management Console](/cdppvc/dsconsole).
