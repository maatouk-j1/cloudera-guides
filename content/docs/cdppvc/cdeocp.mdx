...
topicSlug: "cdppvc"
---
This article explains the steps to deploy the CDE service on the Openshift platform after successful configuration of the [CDP PvC Data Services Management Console](/cdppvc/dsconsole).
...
6. Create the self-signed certificate and inject it into the secret object of the CDE dex-base namespace.
