...
topicSlug: "cdppvc"
---
This article explains the necessary steps to install Cloudera Manager (CM) on CentOS7.9. CentOS7.9 is [one of the supported operating systems](https://supportmatrix.cloudera.com/) in CDP Private Cloud solution. Please ensure that all [prerequisites](prerequisites.md) have already been prepared prior to running this procedure.
...
---    
   Next Step
- Proceed to create the CDP Base cluster in the next [topic](base.md).
