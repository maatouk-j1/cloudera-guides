...
topicSlug: "cdppvc"
---
This article explains the necessary steps to install the minimum services on CDP PvC Base platform prior to installing the CDP PvC Data Services on the Kubernetes platform. Please ensure that all the [prerequisites](/cdppvc/prerequisites) have been prepared and [CM](/cdppvc/cm) has already been installed successfully before running this procedure.
...
14. Review and amend the parameters accordingly. Note that the directory path for services such as HDFS, Ozone and Zookeeper might require dedicated storage disk that is expected to be formatted and mounted prior to this installation as explained in the [prerequisites](/cdppvc/prerequisites) subtopic. The directory must be configured here in accordance to the mounted disk folder name.
...
- Proceed to configure the necessary settings of CDP PvC Base cluster in the next [subtopic](/cdppvc/baseconfig).