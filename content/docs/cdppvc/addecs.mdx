...
24. Create a new environment in the [CDP Data Services Management Console](/cdppvc/dsconsole). After successful creation of the environment, the system might choose this new node to provision the storage. If so, the longhorn dashboard will show that some space has been provisioned in this newly added node.
