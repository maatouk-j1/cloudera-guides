...
2. Create the same `input` file as described in this [threading article](/cml/mthread) with 10000 entries using the simple Bash script in the terminal console.
