...
<Banner type="info">
**Note:** Both configuration captures are recycled from an older lab build - the Cloudera Manager sidebar reads version `7.11.3` against the `7.13.2.6` this guide installs. Read them for the `node_taint` procedure, not for the version shown.
</Banner>
