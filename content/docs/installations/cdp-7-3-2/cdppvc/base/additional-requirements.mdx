...
1. Port requirements for different services on PvC Base Cluster/Data Services (ECS) Cluster:
    ...
    ```text
    https://docs.cloudera.com/cdp-private-cloud-base/7.3.2/cdp-private-cloud-base-installation/topics/cdpdc-ports-used-by-runtime.html
    https://docs.cloudera.com/cdp-private-cloud-base/7.3.2/cdp-private-cloud-base-installation/topics/cdpdc-ports-third-party-components.html
    https://docs.cloudera.com/cdp-private-cloud-base/7.3.2/cdp-private-cloud-base-installation/topics/cdpdc-ports-used-by-cm.html
    https://docs.cloudera.com/cdp-private-cloud-base/7.3.2/cdp-private-cloud-base-installation/topics/cdpdc-service-dependencies.html
