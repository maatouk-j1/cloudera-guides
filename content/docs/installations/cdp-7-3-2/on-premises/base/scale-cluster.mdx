...
<Banner type="warning">
**Optional - skip this step.** It is guidance on sizing, not a procedure to run: nothing here changes the cluster you built in [Data Lake Creation](/installations/cdp-7-3-2/on-premises/base/data-lake).
</Banner>
