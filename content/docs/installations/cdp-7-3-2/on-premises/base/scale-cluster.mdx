...
prevSlug: /installations/cdp-7-3-2/on-premises/base/services-metadata-db-tls
nextTitle: Enable High Availability (Optional)
nextSlug: /installations/cdp-7-3-2/on-premises/base/high-availability
---

<Banner type="warning">
**Optional - skip this step.** The source marks this section *"Optional - Skip this step"*. It is guidance on sizing, not a procedure to run: nothing here changes the cluster you built in [Data Lake Creation](/installations/cdp-7-3-2/on-premises/base/data-lake).
</Banner>
...
The "role assignment recommendation above" and "the table" both refer back to the 22-row host and role assignment table in [Data Lake Creation](/installations/cdp-7-3-2/on-premises/base/data-lake) - this section adds no table of its own.
