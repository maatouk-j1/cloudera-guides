...
1. After the CDP PvC Base cluster has successfully been installed, the dependencies should be reflected in the each service's configurations as shown below. Otherwise, please amend the configurations accordingly.
    ...
    ![Hiveconfig](/images/cdp-7-1-7/cdpbase/hiveconfig.png)
    
    ![Atlasconfig](/images/cdp-7-1-7/cdpbase/atlasconfig.png)
    
    ![Solrconfig](/images/cdp-7-1-7/cdpbase/solrconfig.png)
    
    ![Hdfsconfig](/images/cdp-7-1-7/cdpbase/hdfsconfig.png)
    
    ![Yarnconfig](/images/cdp-7-1-7/cdpbase/yarnconfig.png)
    
    ![Kafkaconfig](/images/cdp-7-1-7/cdpbase/kafkaconfig.png)

    ![Hbaseconfig](/images/cdp-7-1-7/cdpbase/hbaseconfig.png)

    ![Yarnqueueconfig](/images/cdp-7-1-7/cdpbase/yarnqueueconfig.png)
    
    ![Ozoneconfig](/images/cdp-7-1-7/cdpbase/ozoneconfig.png)
...
2. Click the orange button. Click `Restart Stale Services` to take the changes into effect.
    ...
    ![Rangersetting1](/images/cdp-7-1-7/cdpbase/rangersetting1.png)
    
    ![Rangersetting2](/images/cdp-7-1-7/cdpbase/rangersetting2.png)
    
3. Select `Re-deploy client configuration` and click `Restart Now`.

    ![Rangersetting3](/images/cdp-7-1-7/cdpbase/rangersetting3.png)
    
4. The outcome should be successful as shown below.

    ![Rangersetting4](/images/cdp-7-1-7/cdpbase/rangersetting4.png)    
...
1. After successful Ranger usersync's integration with the external LDAP server, log in Ranger dashboard as admin user and check that the LDAP user(s) in LDAP server has successfully been synced and updated in Ranger. 
    ...
    ![Ranger1](/images/cdp-7-1-7/cdpbase/ranger1.png)
    
    ![Ranger2](/images/cdp-7-1-7/cdpbase/ranger2.png)
    
    ![Ranger3](/images/cdp-7-1-7/cdpbase/ranger3.png)
...
1. After successful Ranger usersync's integration with the external LDAP server, log in Atlas dashboard using the LDAP user credentials.
    ...
    ![Atlas1](/images/cdp-7-1-7/cdpbase/atlas1.png)
    
    ![Atlas2](/images/cdp-7-1-7/cdpbase/atlas2.png)       
