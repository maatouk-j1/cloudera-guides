...
topicSlug: "cdppvc"
---
This article explains the steps to deploy the CDW service on Openshift platform after successful configuration of the [CDP PvC Data Services Management Console](/installations/cdp-7-1-7/cdppvc/dsconsole).
...
1. This is a mandatory step to allow other user to impersonate `hive` user to access Hive tables. This is the Hive default setting and Ranger is the only supported and recommended security model. Ensure that Hive Impersonation is enabled as shown below.
    ...
    ![Hiveimpersonation](/images/cdp-7-1-7/cdw/hiveimpersonation.png)  
...
2. The system will redirect the browser to the following page. Log in using LDAP user credential and click `Data Warehouse`.   
    ...
    ![Dslogin1](/images/cdp-7-1-7/dsconsole/dslogin1.png)
    
    ![Dslogin2](/images/cdp-7-1-7/dsconsole/dslogin2.png)

3. Click the thunder icon of the newly created data lake environment. Fill in the parameters using LDAP user credentials. Note that the databases must be pre-created as highlighted in the [prerequisites](/installations/cdp-7-1-7/cdppvc/prerequisites) topic. 

    ![Ocpcdw1](/images/cdp-7-1-7/ocp4/ocpcdw1.png)

    ![Ocpcdw2](/images/cdp-7-1-7/ocp4/ocpcdw2.png)
    
4. Create a new `Hive` virtual warehouse with 1 executor as shown below.

    ![Ocpcdw3](/images/cdp-7-1-7/ocp4/ocpcdw3.png) 

    ![Ocpcdw4](/images/cdp-7-1-7/ocp4/ocpcdw4.png) 
...
5. Remove the above `Hive` virtual warehouse. Create a new `Impala` virtual warehouse with 1 executor as shown in the following example.
    ...
    ![Ocpcdw5](/images/cdp-7-1-7/ocp4/ocpcdw5.png) 
    
    ![Ocpcdw6](/images/cdp-7-1-7/ocp4/ocpcdw6.png) 
...
6. Remove the above `Impala` virtual warehouse. Create a new `Impala` virtual warehouse with 4 executors as shown below.
    ...
    ![Ocpcdw7](/images/cdp-7-1-7/ocp4/ocpcdw7.png) 
    
    ![Ocpcdw8](/images/cdp-7-1-7/ocp4/ocpcdw8.png) 
