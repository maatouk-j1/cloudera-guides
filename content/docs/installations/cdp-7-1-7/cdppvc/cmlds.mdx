...
topicSlug: "cdppvc"
---
This article explains the steps to deploy the CML service on the Kubernetes platform after successful configuration of the [CDP PvC Data Services Management Console](/installations/cdp-7-1-7/cdppvc/dsconsole).
...
1. Navigate to `AMP`. You may select one of the Applied ML Prototypes. In this demo, click `Deep Learning for Image Analysis`.
    ...
    ![Cmluser2](/images/cdp-7-1-7/cml/cmluser2.png)  

2. Click `Configure Project`.

    ![Cmluser3](/images/cdp-7-1-7/cml/cmluser3.png)  
    
    ![Cmluser4](/images/cdp-7-1-7/cml/cmluser4.png)  
    
3. Select the parameters. Click `Launch Project`.

    ![Cmluser5](/images/cdp-7-1-7/cml/cmluser5.png)  
    
    ![Cmluser6](/images/cdp-7-1-7/cml/cmluser6.png)  

    ![Cmluser7](/images/cdp-7-1-7/cml/cmluser7.png)  
...
4. Click `Open` to browse the application as shown in the following animated gif. The application user may click on any image at the lower section and then the application will analyze the library and subsequently display a list of similar image's type that was clicked by the user.
    ...
    ![Cmlanalysis](/images/cdp-7-1-7/cml/cmlanalysis.gif)  
