...
topicSlug: "cdppvc"
---
This article explains the steps to deploy the CDW service on ECS platform after successful configuration of the [CDP PvC Data Services Management Console](/installations/cdp-7-1-7/cdppvc/dsconsole).
...
1. In CM, navigate to `Data Services`. Click `Open CDP Private Cloud Data Services`. 
    ...
    ![Cmds](/images/cdp-7-1-7/dsconsole/cmds.png)
...
3. Click the thunder icon of the newly created data lake environment. Fill in the parameters using LDAP user credentials. Note that the databases must be pre-created as highlighted in the [prerequisites](/installations/cdp-7-1-7/cdppvc/prerequisites) topic. 
    ...
    ![Cdw1](/images/cdp-7-1-7/cdw/cdw1.png)

4. Create a new database catalog. 

    ![Cdw2](/images/cdp-7-1-7/cdw/cdw2.png)
    
5. Create a new virtual warehouse as shown in the following example.

    ![Cdw3](/images/cdp-7-1-7/cdw/cdw3.png)    
    
    ![Cdw4](/images/cdp-7-1-7/cdw/cdw4.png)   
