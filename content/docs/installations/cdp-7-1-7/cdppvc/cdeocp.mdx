...
topicSlug: "cdppvc"
---
This article explains the steps to deploy the CDE service on the Openshift platform after successful configuration of the [CDP PvC Data Services Management Console](/installations/cdp-7-1-7/cdppvc/dsconsole).
...
7. After the successful completion of the previous step, you may now access the `AIRFLOW UI` and the `GRAFANA CHARTS`.
    ...
    ![Cdeocp5](/images/cdp-7-1-7/cde/cdeocp5.png)
    
    ![Cdeocp6](/images/cdp-7-1-7/cde/cdeocp6.png)
    
    ![Cdeocp7](/images/cdp-7-1-7/cde/cdeocp7.png)
