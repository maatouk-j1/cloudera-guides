...
3. In CM, navigate to `Clusters` > `ECS` > `Storage UI` to launch the Longhorn dashboard. Click `Node` at the Longhorn dashboard. Note that ecsworker3.cdpkvm.cldr node has 4 volume replicas currently.
    ...
    ![Scaledisk1](/images/cdp-7-1-7/ecs/scaledisk1.png)
...
8. The Longhorn dashboard should reflect that the ecsworker3.cdpkvm.cldr node is now `Unschedulable` and has no volume replica.
    ...
    ![Scaledisk2](/images/cdp-7-1-7/ecs/scaledisk2.png)
...
26. The Longhorn dashboard should now indicate that the ecsworker3.cdpkvm.cldr node is `Schedulable`.
    ...
    ![Scaledisk8](/images/cdp-7-1-7/ecs/scaledisk8.png)
...
27. Provision a new CML workspace and the system might select ecsworker3.cdpkvm.cldr node to store the Longhorn volume replicas. In this case, 4 volumes have successfully been created in ecsworker3.cdpkvm.cldr node.
    ...
    ![Scaledisk9](/images/cdp-7-1-7/ecs/scaledisk9.png)
