...
4. In CML, navigate to Site Administration > Runtime/Engine and add the new docker image under the `Engine Images` section.
    ...
    ![Customimage1](/images/cdp-7-1-7/cml/customimage1.png)
